...
namespace Microsoft.AspNetCore.Components.Routing
{
    internal class RouteTable
    {
        ...
        public RouteTable(List<RouteEntry> routes)
        {
            Routes = routes;
        }
        ...
        internal void AddRoutesFromAssemblies(IEnumerable<Assembly> assemblies) {
            var components = assemblies.SelectMany(a => a.ExportedTypes.Where(t => typeof(IComponent).IsAssignableFrom(t)));
            ...
            AddRoutesFromComponent(components);
        }

        internal void AddRoutesFromComponent(IEnumerable<Type> componentTypes) {
            ...
            AddRoutesFromTemplates(templatesByHandler);
        }

        internal void AddRoutesFromTemplates(Dictionary<Type, string[]> templatesByHandler)
        {
            ...
            var sortedRoutes = routes.OrderBy(id => id, RoutePrecedence);
